...
(50) DEFAULT NULL,
  `bike_condition` enum
('NEW','USED_LIKE_NEW','USED_GOOD','USED_FAIR') DEFAULT NULL,
  `status` enum
('PENDING','APPROVED','REJECTED','SOLD') DEFAULT 'PENDING',
...
(12,2) DEFAULT NULL,
  `status` enum
('PENDING','DEPOSITED','COMPLETED','RECEIVED','CANCELLED') DEFAULT 'PENDING',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `bikes`
ADD CONSTRAINT `bikes_ibfk_1` FOREIGN KEY
(`seller_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `bikes_ibfk_2` FOREIGN KEY
(`brand_id`) REFERENCES `brands`
(`brand_id`),
ADD CONSTRAINT `bikes_ibfk_3` FOREIGN KEY
...
--
ALTER TABLE `bike_images`
ADD CONSTRAINT `bike_images_ibfk_1` FOREIGN KEY
(`bike_id`) REFERENCES `bikes`
(`bike_id`) ON
DELETE CASCADE;
...
--
ALTER TABLE `inspection_reports`
ADD CONSTRAINT `inspection_reports_ibfk_1` FOREIGN KEY
(`bike_id`) REFERENCES `bikes`
(`bike_id`),
ADD CONSTRAINT `inspection_reports_ibfk_2` FOREIGN KEY
(`inspector_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `messages`
ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY
(`sender_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY
(`receiver_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `messages_ibfk_3` FOREIGN KEY
(`bike_id`) REFERENCES `bikes`
(`bike_id`);
...
(`user_id`),
ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY
(`seller_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `reports`
ADD CONSTRAINT `reports_ibfk_1` FOREIGN KEY
(`reporter_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `reports_ibfk_2` FOREIGN KEY
(`bike_id`) REFERENCES `bikes`
(`bike_id`);
...
(`buyer_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `reviews_ibfk_3` FOREIGN KEY
(`seller_id`) REFERENCES `users`
(`user_id`);
...
--
ALTER TABLE `wishlist`
ADD CONSTRAINT `wishlist_ibfk_1` FOREIGN KEY
(`buyer_id`) REFERENCES `users`
(`user_id`),
ADD CONSTRAINT `wishlist_ibfk_2` FOREIGN KEY
(`bike_id`) REFERENCES `bikes`
(`bike_id`);
COMMIT;
